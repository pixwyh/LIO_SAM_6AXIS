...
# image name: markjin/lidar_mapping
...
RUN git clone http://172.16.4.20:9010/j290941928/gtsam.git \
...
# RUN cd src && git clone http://172.16.4.20:9010/autonomous_driving/lio_sam_6axis.git
